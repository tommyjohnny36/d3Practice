...
!(function (t, n) {
  ...
  function Nv(t, n) {
    var e = t.getDay();
    return Yy(
      (t = e >= 4 || 0 === e ? Rg(t) : Rg.ceil(t)).getFullYear() % 1e4,
      n,
      4
    );
  }
  ...
  function t_(n) {
    return (
      (Fy = Ry(n)),
      (t.timeFormat = Fy.format),
      (t.timeParse = Fy.parse),
      (t.utcFormat = Fy.utcFormat),
      (t.utcParse = Fy.utcParse),
      Fy
    );
  }
  (t.timeFormat = void 0),
    ...
    Hm = {
      draw: function (t, n) {
        ...
        t.moveTo(r, i),
          t.lineTo(o, a),
          t.lineTo(u, c),
          t.lineTo(Bm * r - Ym * i, Ym * r + Bm * i),
          t.lineTo(Bm * o - Ym * a, Ym * o + Bm * a),
          t.lineTo(Bm * u - Ym * c, Ym * u + Bm * c),
          t.lineTo(Bm * r + Ym * i, Bm * i - Ym * r),
          t.lineTo(Bm * o + Ym * a, Bm * a - Ym * o),
          t.lineTo(Bm * u + Ym * c, Bm * c - Ym * u),
          t.closePath();
      },
    },
  ...
  function yx(t, n, e) {
    var r = t._x1 - t._x0,
      ...
      u = (o * i + a * r) / (r + i);
    return (
      (gx(o) + gx(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(u)) ||
      0
    );
  }
  function vx(t, n) {
  ...
  Rx.prototype = {
    ...
    translate: function (t, n) {
      return (0 === t) & (0 === n)
        ? this
        : new Rx(this.k, this.x + this.k * t, this.y + this.k * n);
    },
    apply: function (t) {
  ...
  var Fx = new Rx(1, 0, 0);
  function Ox(t) {
    for (; !t.__zoom; ) if (!(t = t.parentNode)) return Fx;
    return t.__zoom;
  }
  function Ux(t) {
    t.stopImmediatePropagation();
  ...
  (Ox.prototype = Rx.prototype),
    ...
    (t.curveBundle = Jm),
    (t.curveCardinal = ex),
    (t.curveCardinalClosed = ix),
    (t.curveCardinalOpen = ax),
    (t.curveCatmullRom = fx),
    (t.curveCatmullRomClosed = lx),
    (t.curveCatmullRomOpen = dx),
    (t.curveLinear = cm),
    ...
    (t.scaleLog = function t() {
      ...
      return (
        (n.copy = () => Fp(n, t()).base(n.base())), Ap.apply(n, arguments), n
      );
    }),
    (t.scaleOrdinal = Ep),
    ...
    (t.stackOrderAppearance = Nx),
    (t.stackOrderAscending = Px),
    ...
    (t.zoom = function () {
      ...
      return (
        ...
        (y.wheelDelta = function (t) {
          return arguments.length
            ? ((a = "function" == typeof t ? t : Dx(+t)), y)
            : a;
        }),
        (y.filter = function (t) {
          return arguments.length
            ? ((r = "function" == typeof t ? t : Dx(!!t)), y)
            : r;
        }),
